...
public final class ActivityBarcodeBinding implements ViewBinding {
  ...
  private ActivityBarcodeBinding(@NonNull FrameLayout rootView, @NonNull Button backButton,
  ...
  public static ActivityBarcodeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityBarcodeBinding((FrameLayout) rootView, backButton, listViewBarcodeData);
    }
